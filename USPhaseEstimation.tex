...
\vskip0.75ex
\noindent
\textbf{Contributions.} In this paper, we present a method for the estimation of instantaneous cardiac and respiratory phases directly from the cardiac ultrasound video (Figure~\ref{fig:instaphase_vs_ecg}). We also present a robust non-parametric regression technique for gating out respiratory frames and a kernel regression model for reconstructing images at any cardiac phase to facilitate temporal super-resolution. 
%
\begin{figure*}[t]
\centering
