...
%	
	...
	We also compared the performance of our phase estimation method with three previously published methods: Phase correlation approach of Sundat\etal~\cite{Sundar2009}, Manifold learning approach of Wachinger\etal~\cite{Wachinger2012}, and Masked PCA approach of Panayiotou\etal~\cite{Panayiotou2014}. Table~\ref{table:R_peak_localization} reports the $mean \pm stddev$ error of different methods in locating the frames corresponding to the R-wave peaks of the ECG signal for all 6 videos. 
%	
\begin{table}[h]
\begin{minipage}[t]{0.95\linewidth}
\centering
